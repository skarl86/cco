...
import { workProductsRouter, workProductsDirectRouter } from './routes/work-products.js';
...
export function createApp(config: AppConfig): App {
  ...
  app.use('/api/teams/:teamId/tasks/:taskId/work-products', workProductsRouter(database));
  ...
  app.use('/api/teams/:teamId/work-products', workProductsDirectRouter(database));
